...
{
    public static class ConsultaDebitosTaxas
    {
        // Esta Pesquisa contempla a segregação das taxas do serviço 3 - Licenciamento + Transferência.
        // Referencia na documentação Daycoval[/ConsultarDebitos/v2]

        public static string PesquisaDebitoTaxas(string renavam, string codServico
                                                ...
                                                , string tipoConsulta)
        {
            ...
            string url = "http://187.9.76.122:8901/Debito/ConsultarDebitos/v2";
            ASCIIEncoding encoder = new ASCIIEncoding();
            byte[] data = encoder.GetBytes(json);//Aqui no meio vai o json
